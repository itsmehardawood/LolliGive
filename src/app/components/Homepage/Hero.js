...
//           fill
//           priority
//           className="object-cover rounded-b-[80px] sm:rounded-b-[120px] lg:rounded-b-[180px]"
//         />
//       </div>

//       {/* White Box Overlay */}
//       <div className="absolute inset-0 flex items-center justify-center sm:justify-start px-4 sm:px-8">
//         <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-12 text-center shadow-lg max-w-xs sm:max-w-sm lg:max-w-lg w-full sm:w-auto">
