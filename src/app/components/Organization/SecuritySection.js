...
export default function SecuritySection({ securityData }) {
  const {
    title = "LolliGive Security Measures",
    subtitle = "At LolliGive, protecting your financial information and ensuring the integrity of our platform is our top priority. We have implemented industry-leading security practices to safeguard every transaction and maintain the trust of our churches, organizations, and donors.",
    leftPoints = [
